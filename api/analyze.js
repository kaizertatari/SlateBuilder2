...
- groundTruth.win_prob.player_team_pct                                                        → 0-1 float (multiply by 100 for the % the framework uses). Applies to Rule 5f blowout suppressor on OVERs AND to the [v3.4 R9] assist win-prob gate — band is [0.40, 0.75] regular season, [0.45, 0.70] playoff (groundTruth.series non-null). For assist-containing props outside the band, SKIP.
