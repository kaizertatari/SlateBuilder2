// Authoritative NBA team-id ↔ abbreviation mapping. Single source of truth
// for both api/ runtime and offline scripts. ESPN's abbreviations differ in a
// few cases (handled in api/lib/espn.js).
